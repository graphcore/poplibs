...
int main(int argc, char **argv) {
  ...
  Net net(IMAGENET,
          ...
          makeLayers({
            ...
            new ConvResLayer(1, 1, 1, 1, 0, 0, 256, NON_LINEARITY_RELU, 3,
                             resMethod),
            new ConvLayer(1, 1, 1, 1, 0, 0, 64, NON_LINEARITY_RELU),
            new ConvLayer(3, 3, 1, 1, 1, 1, 64, NON_LINEARITY_RELU),
            new ConvResLayer(1, 1, 1, 1, 0, 0, 256, NON_LINEARITY_RELU, 3,
            ...
            // DOWN SAMPLE
            new ConvLayer(1, 1, 2, 2, 0, 0, 128, NON_LINEARITY_RELU),
            new ConvLayer(3, 3, 1, 1, 1, 1, 128, NON_LINEARITY_RELU),
            new ConvResLayer(1, 1, 1, 1, 0, 0, 512, NON_LINEARITY_RELU, 3,
                             resMethod),
            ...
            // DOWN SAMPLE
            new ConvLayer(1, 1, 2, 2, 0, 0, 256, NON_LINEARITY_RELU),

            new ConvLayer(3, 3, 1, 1, 1, 1, 256, NON_LINEARITY_RELU),
            new ConvResLayer(1, 1, 1, 1, 0, 0, 1024, NON_LINEARITY_RELU, 3,
                             resMethod),
            ...
            // DOWN SAMPLE
            new ConvLayer(1, 1, 2, 2, 0, 0, 512, NON_LINEARITY_RELU),
            new ConvLayer(3, 3, 1, 1, 1, 1, 512, NON_LINEARITY_RELU),
            new ConvResLayer(1, 1, 1, 1, 0, 0, 2048, NON_LINEARITY_RELU, 3,
                             resMethod),

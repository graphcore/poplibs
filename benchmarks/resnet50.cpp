...
int main(int argc, char **argv) {
  ...
  Net net(IMAGENET,
          ...
          makeLayers({
            ...
            // 7x7,64, stride 2
            new ConvLayer(7, 7, 2, 2, 3, 3, 64, NON_LINEARITY_RELU),
            // 3x3 max pool, stride 2
            new MaxPoolLayer(3, 2, 1),

            // 1x1,64 -> 3x3, 64-> 1x1, 256 (residual) X 3
            new ConvLayer(1, 1, 1, 1, 0, 0, 64, NON_LINEARITY_RELU),
            new ConvLayer(3, 3, 1, 1, 1, 1, 64, NON_LINEARITY_RELU),
            new ConvResLayer(1, 1, 1, 1, 0, 0, 256, NON_LINEARITY_RELU, 3, resMethod),
            new ConvLayer(1, 1, 1, 1, 0, 0, 64, NON_LINEARITY_RELU),
            new ConvLayer(3, 3, 1, 1, 1, 1, 64, NON_LINEARITY_RELU),
            new ConvResLayer(1, 1, 1, 1, 0, 0, 256, NON_LINEARITY_RELU, 3, resMethod),
            new ConvLayer(1, 1, 1, 1, 0, 0, 64, NON_LINEARITY_RELU),
            ...
            new ConvLayer(1, 1, 2, 2, 0, 0, 128, NON_LINEARITY_RELU),  // DOWN SAMPLE
            new ConvLayer(3, 3, 1, 1, 1, 1, 128, NON_LINEARITY_RELU),
            new ConvResLayer(1, 1, 1, 1, 0, 0, 512, NON_LINEARITY_RELU, 3, resMethod),
            new ConvLayer(1, 1, 1, 1, 0, 0, 128, NON_LINEARITY_RELU),
            new ConvLayer(3, 3, 1, 1, 1, 1, 128, NON_LINEARITY_RELU),
            new ConvResLayer(1, 1, 1, 1, 0, 0, 512, NON_LINEARITY_RELU, 3, resMethod),
            new ConvLayer(1, 1, 1, 1, 0, 0, 128, NON_LINEARITY_RELU),
            new ConvLayer(3, 3, 1, 1, 1, 1, 128, NON_LINEARITY_RELU),
            ...
            new ConvLayer(1, 1, 2, 2, 0, 0, 256, NON_LINEARITY_RELU),  // DOWN SAMPLE
            new ConvLayer(3, 3, 1, 1, 1, 1, 256, NON_LINEARITY_RELU),
            new ConvResLayer(1, 1, 1, 1, 0, 0, 1024, NON_LINEARITY_RELU, 3, resMethod),
            new ConvLayer(1, 1, 1, 1, 0, 0, 256, NON_LINEARITY_RELU),
            new ConvLayer(3, 3, 1, 1, 1, 1, 256, NON_LINEARITY_RELU),
            new ConvResLayer(1, 1, 1, 1, 0, 0, 1024, NON_LINEARITY_RELU, 3, resMethod),
            new ConvLayer(1, 1, 1, 1, 0, 0, 256, NON_LINEARITY_RELU),
            new ConvLayer(3, 3, 1, 1, 1, 1, 256, NON_LINEARITY_RELU),
            ...
            new ConvLayer(1, 1, 2, 2, 0, 0, 512, NON_LINEARITY_RELU),  // DOWN SAMPLE
            new ConvLayer(3, 3, 1, 1, 1, 1, 512, NON_LINEARITY_RELU),
            new ConvResLayer(1, 1, 1, 1, 0, 0, 2048, NON_LINEARITY_RELU, 3, resMethod),
            new ConvLayer(1, 1, 1, 1, 0, 0, 512, NON_LINEARITY_RELU),
            new ConvLayer(3, 3, 1, 1, 1, 1, 512, NON_LINEARITY_RELU),
            new ConvResLayer(1, 1, 1, 1, 0, 0, 2048, NON_LINEARITY_RELU, 3, resMethod),
            new ConvLayer(1, 1, 1, 1, 0, 0, 512, NON_LINEARITY_RELU),
            new ConvLayer(3, 3, 1, 1, 1, 1, 512, NON_LINEARITY_RELU),

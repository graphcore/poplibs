...
fields = [
    ...
    ('Send instruction bytes',
     'Send\s*:\s*(?P<value>[0-9.]+) bytes'),
    ('RMUX instruction bytes',
     'Receive mux\s*:\s*(?P<value>[0-9.]+) bytes'),
    ('RPTR instruction bytes',
     'Receive ptr\s*:\s*(?P<value>[0-9.]+) bytes'),
    ('Nop instruction bytes',
     'Nop\s*:\s*(?P<value>[0-9.]+) bytes'),
    ('Tile sync',
...
def write(runs, filename):
    ...
    headings2 = [
        ...
        ('RMUX instruction bytes', setDataCell),
        ('RPTR instruction bytes', setDataCell),
        ('Nop instruction bytes', setDataCell),
        ('Exchange supervisor code', setDataCell),
        ('Message memory', setDataCell),
        ('Run instructions', setDataCell),

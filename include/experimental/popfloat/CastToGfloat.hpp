...
public:
  ...
  struct CastConfig {
    ...
    createCastNativeToGF(experimental::popfloat::FormatType formatType,
                         poplar::Type calculationType,
                         poplar::Type nativeType, poplar::Type storageType,
    ...
    const poplar::Type getNativeType() const { return nativeType; }
  ...
  private:
    CastConfig(experimental::popfloat::FormatType floatFormatType,
               poplar::Type calculationType, poplar::Type nativeType,
    ...
    /*
     * nativeType: the native type to represent a custom float format.
     * NOTE: This can be copied from the nativeType chosen by FormatConfig,
     * or can be selected by the user. This could result is losing precision
     * if IEEE FP16 is chosen instead for gflot formats that can oly be
     * represented using IEEE FP32.
     */
    poplar::Type nativeType;
   ...
   *
   * The shape of the tensor will be depend on the calculation type
   *

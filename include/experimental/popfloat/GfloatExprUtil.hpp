...
namespace poputil {
template <> struct VertexTemplateToString<experimental::popfloat::RoundType> {
...
template <> struct VertexTemplateToString<experimental::popfloat::FormatType> {
...
struct VertexTemplateToString<experimental::popfloat::SRDensityType> {
  static std::string
  to_string(const experimental::popfloat::SRDensityType &dist) {

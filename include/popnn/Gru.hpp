...
/**
 * Structure holding all the parameters of an GRU cell, or the
 ...
 *  of an GRU. Returns the inputWeights and outputWeights.
 */
...
/** Calculate the result of applying an GRU across a sequence
 *
 ...
 *
 * notes: * is matric multiplication
 ...
 *
 * \param graph              Graph to which the GRU cell belongs to
 ...
 *                           backward pass. It includes the data for reset gate,
 *                           update gate, candidate, and output if
                             outputFullSequence is false. This argument should
                             be set to null if we are only doing inference.
...
/**
 *  Run GRU backward pass. The backward pass executes in reverse order as
 *  compared to the forward pass. If the forward steps for a GRU layer are sf =
 ...
 * \param fwdIntermediatesSeq Intermediates results from the foward pass
 * \param weights             The GRU weights structure
 ...
 *
 *  \param graph            Graph which the GRU cell belongs to.
 *  \param params           The parameters of the GRU.

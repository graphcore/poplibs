...
class vv_iterator_util {
  ...
  template<typename T>
  friend class vv_iterator;
  template<typename T>
  friend class vv_const_iterator;
...
private:
  vv_iterator(std::vector<std::vector<T>>* vv,
              std::size_t idxOuter,
              std::size_t idxInner)
...
private:
  vv_const_iterator(const std::vector<std::vector<T>>* vv,
                    std::size_t idxOuter,
                    std::size_t idxInner)
    : vv(vv), idxOuter(idxOuter), idxInner(idxInner) {}

...
#define scale             a0:1
#define isNanOrInf        a0:1
#define isTie             a0:1
#define outBitMaskV4      a0:1
#define dnrmManMaskV4     a0:1
#define truncBitsV4       a0:1
...
#define clampInput        a2:3
#define expV4             a2:3
#define halfExpMaskV4     a2:3
#define inputClampF32     a2:3
#define manLsbMaskV4      a2:3
#define signV4            a2:3
#define srMaskV4          a2:3
#define halfMinDnrmV4     a2:3

#define scaledMin         a4
#define scaledClamp       a4

#define inValueV2_0       a4:5
#define inValueV4         a4:5
#define isDenormV4        a4:5
#define isMaxExpV4        a4:5
#define isPositiveV4      a4:5
#define isNegativeV4      a4:5
#define nanInfValue       a4:5
#define randomBitsV4      a4:5
#define nonZeroV4         a4:5
#define roundCorrV4       a4:5
#define qNanV4            a4:5

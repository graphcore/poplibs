...
template <typename FPType, bool NANOO, RoundType RMODE>
class CastToGfloat16InPlaceSupervisor
...
public:
  ...
  bool compute() {
    ...
    for (unsigned j = 0; j != nv; ++j, len -= POPFLOAT_GF16_VEC_SIZE) {
      ...
      uint64_t corrV4 =
          gfloat16_correction(inValueV4, manMaskV4, expV4, (RoundType)RMODE);
...
#define CAST_TO_GFLOAT16_INPLACE(RM)                                           \
  template class CastToGfloat16InPlaceSupervisor<half, true, RM>;              \
  template class CastToGfloat16InPlaceSupervisor<float, true, RM>;             \
  template class CastToGfloat16InPlaceSupervisor<half, false, RM>;             \
  template class CastToGfloat16InPlaceSupervisor<float, false, RM>;

CAST_TO_GFLOAT16_INPLACE(popfloat::experimental::RoundType::RZ)
CAST_TO_GFLOAT16_INPLACE(popfloat::experimental::RoundType::RA)
CAST_TO_GFLOAT16_INPLACE(popfloat::experimental::RoundType::RN)
CAST_TO_GFLOAT16_INPLACE(popfloat::experimental::RoundType::RU)
CAST_TO_GFLOAT16_INPLACE(popfloat::experimental::RoundType::RD)
CAST_TO_GFLOAT16_INPLACE(popfloat::experimental::RoundType::SR)
CAST_TO_GFLOAT16_INPLACE(popfloat::experimental::RoundType::SX)

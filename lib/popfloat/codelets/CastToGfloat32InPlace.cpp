...
template <bool NANOO, RoundType RMODE>
class CastToGfloat32InPlaceSupervisor
...
#define CAST_TO_GFLOAT32_INPLACE(RM)                                           \
  template class CastToGfloat32InPlaceSupervisor<true, RM>;                    \
  template class CastToGfloat32InPlaceSupervisor<false, RM>;

CAST_TO_GFLOAT32_INPLACE(popfloat::experimental::RoundType::RZ)
CAST_TO_GFLOAT32_INPLACE(popfloat::experimental::RoundType::RA)
CAST_TO_GFLOAT32_INPLACE(popfloat::experimental::RoundType::RN)
CAST_TO_GFLOAT32_INPLACE(popfloat::experimental::RoundType::RU)
CAST_TO_GFLOAT32_INPLACE(popfloat::experimental::RoundType::RD)
CAST_TO_GFLOAT32_INPLACE(popfloat::experimental::RoundType::SR)
CAST_TO_GFLOAT32_INPLACE(popfloat::experimental::RoundType::SX)

...
class CastToGfloat32SrSupervisor
    : public SupervisorVertexIf<ASM_CODELETS_ENABLED> {
public:
  CastToGfloat32SrSupervisor();
...
#define CAST_TO_GFLOAT32SR(RM)                                                 \
  template class CastToGfloat32SrSupervisor<float, float, true, RM>;           \
  template class CastToGfloat32SrSupervisor<float, float, false, RM>;          \
  template class CastToGfloat32SrSupervisor<float, half, true, RM>;            \
  template class CastToGfloat32SrSupervisor<float, half, false, RM>;

CAST_TO_GFLOAT32SR(popfloat::experimental::SRDensityType::UNIFORM);
CAST_TO_GFLOAT32SR(popfloat::experimental::SRDensityType::NORMAL);
CAST_TO_GFLOAT32SR(popfloat::experimental::SRDensityType::TRUNCATED_NORMAL);
CAST_TO_GFLOAT32SR(popfloat::experimental::SRDensityType::BERNOULLI);
CAST_TO_GFLOAT32SR(popfloat::experimental::SRDensityType::LOGISTIC);
CAST_TO_GFLOAT32SR(popfloat::experimental::SRDensityType::TRUNCATED_LOGISTIC);
CAST_TO_GFLOAT32SR(popfloat::experimental::SRDensityType::LAPLACE);
CAST_TO_GFLOAT32SR(popfloat::experimental::SRDensityType::TRUNCATED_LAPLACE);
CAST_TO_GFLOAT32SR(popfloat::experimental::SRDensityType::LOGIT_NORMAL);
CAST_TO_GFLOAT32SR(

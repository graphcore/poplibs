...
#define POPFLOAT_VBASE_CAST_INPLACE_CORR_PARAMS_PTR_OFFSET  5
#define POPFLOAT_VBASE_CAST_INPLACE_DIST_PARAM_PTR_OFFSET   6
#define POPFLOAT_VBASE_CAST_SR_MASK_OFFSET                  6
#define POPFLOAT_VBASE_CAST_CORR_PARAMS_PTR_OFFSET          7
#define POPFLOAT_VBASE_CAST_DIST_PARAM_PTR_OFFSET           8
...
#define POPFLOAT_CAST_TO_GF16_PARAM_CLAMP_FP16_IN_OFFSET    16
#define POPFLOAT_CAST_TO_GF16_PARAM_CLAMP_OUTPUT_OFFSET     17
#define POPFLOAT_CAST_TO_GF16_PARAM_MIN_OUTPUT_OFFSET       18
#define POPFLOAT_CAST_TO_GF16_PARAM_POWER2_M_MAN_10_OFFSET  19
#define POPFLOAT_CAST_TO_GF16_PARAM_POWER2_M1_OFFSET        20
#define POPFLOAT_CAST_TO_GF16_PARAM_POWER2_10_OFFSET        21
#define POPFLOAT_CAST_TO_GF16_TOTAL_PARAM_SIZE              22

//GF16 SR Correction Parameters
#define POPFLOAT_CAST_TO_GF16_SR_CORR_SCALE_PARAMS_OFFSET   0
#define POPFLOAT_CAST_TO_GF16_SR_CORR_CLAMP_PARAMS_OFFSET   1
...
#define POPFLOAT_CAST_TO_GF32_PARAM_MIN_VALUE_OFFSET        16
#define POPFLOAT_CAST_TO_GF32_PARAM_MIN_NORM_OFFSET         17
#define POPFLOAT_CAST_TO_GF32_PARAM_EN_DENORM_OFFSET        18
#define POPFLOAT_CAST_TO_GF32_TOTAL_PARAM_SIZE              19

//GF16 SR Correction Parameters
#define POPFLOAT_CAST_TO_GF32_SR_CORR_SCALE_PARAMS_OFFSET   0
#define POPFLOAT_CAST_TO_GF32_SR_CORR_CLAMP_PARAMS_OFFSET   2

/*!
 CAST FLOAT TO GF16
  */
//GF16 Parameters
#define POPFLOAT_FP32_TO_GF16_PARAM_EXPONENT_MASK_OFFSET    0
#define POPFLOAT_FP32_TO_GF16_PARAM_MAN_EXP_MASK_OFFSET     2
#define POPFLOAT_FP32_TO_GF16_PARAM_EXP_ALIGN_OFFSET        4
#define POPFLOAT_FP32_TO_GF16_PARAM_FP16_SHR_ALIGN_OFFSET   5
#define POPFLOAT_FP32_TO_GF16_PARAM_MIN_NORM_OFFSET         6
#define POPFLOAT_FP32_TO_GF16_TOTAL_PARAM_SIZE              7

/*!
  CAST GF16 TO FLOAT
 */
//Scratch space
#define POPFLOAT_GF16_TO_FP32_STACK_IN_VALUE_OFFSET         0
#define POPFLOAT_GF16_TO_FP32_STACK_IN_BASE_PTR_OFFSET      2
#define POPFLOAT_GF16_TO_FP32_STACK_OUT_BASE_PTR_OFFSET     3
#define POPFLOAT_GF16_TO_FP32_TOTAL_STACK_SIZE              4

//GF16 Parameters
#define POPFLOAT_GF16_TO_FP32_PARAM_EXP_MASK_OFFSET         0
#define POPFLOAT_GF16_TO_FP32_PARAM_CLAMP_OFFSET            2
#define POPFLOAT_GF16_TO_FP32_PARAM_MIN_NORM_OFFSET         4
#define POPFLOAT_GF16_TO_FP32_PARAM_EXP_ALIGN_OFFSET        6
#define POPFLOAT_GF16_TO_FP32_PARAM_SHIFT0_OFFSET           7
#define POPFLOAT_GF16_TO_FP32_PARAM_SHIFT1_OFFSET           8
#define POPFLOAT_GF16_TO_FP32_TOTAL_PARAM_SIZE              9

/*!
  CAST HALF TO GF8
  */
//Scratch space
#define POPFLOAT_FP16_TO_GF8_STACK_EXPONENT_MASK_OFFSET     0
#define POPFLOAT_FP16_TO_GF8_STACK_SIGN_MASK_OFFSET         2
#define POPFLOAT_FP16_TO_GF8_STACK_MAX_EXP_OFFSET           4

//GF8 PARAMS
#define POPFLOAT_FP16_TO_GF8_PARAM_MAN_EXP_MASK_OFFSET      0
#define POPFLOAT_FP16_TO_GF8_PARAM_SHR_ALIGN_OFFSET         2
#define POPFLOAT_FP16_TO_GF8_TOTAL_PARAM_SIZE               3

/*!
  CAST GF8 TO HALF
 */
//SCRATCH
#define POPFLOAT_GF8_TO_FP16_STACK_IN_VALUE_OFFSET          0
#define POPFLOAT_GF8_TO_FP16_STACK_IN_BASE_PTR_OFFSET       2
#define POPFLOAT_GF8_TO_FP16_STACK_OUT_BASE_PTR_OFFSET      3
#define POPFLOAT_GF8_TO_FP16_TOTAL_STACK_SIZE               4

//GF8 Parameters
#define POPFLOAT_GF8_TO_FP16_PARAM_EXPONENT_MASK_OFFSET     0
#define POPFLOAT_GF8_TO_FP16_PARAM_MAX_EXPONENT_OFFSET      2
#define POPFLOAT_GF8_TO_FP16_PARAM_CLAMP_INPUT_OFFSET       4
#define POPFLOAT_GF8_TO_FP16_PARAM_SHR_ALIGN_OFFSET         5
#define POPFLOAT_GF8_TO_FP16_PARAM_SIGN_MASK_OFFSET         6
#define POPFLOAT_GF8_TO_FP16_TOTAL_PARAM_SIZE               7
...
#define POPFLOAT_GF_STRUCT_ENINF_MASK\
        (1 << POPFLOAT_GF_STRUCT_ENINF_BIT_OFFSET)
...
/*!
 Rounding modes
 */
#define POPFLOAT_ROUND_TO_ZERO                              (0)
#define POPFLOAT_ROUND_TO_NEAREST_EVEN                      (1)
#define POPFLOAT_ROUND_TO_NEAREST_AWAY                      (2)
#define POPFLOAT_ROUND_TO_POS_INF                           (3)
#define POPFLOAT_ROUND_TO_NEG_INF                           (4)
#define POPFLOAT_ROUND_STOCHASTIC                           (5)
#define POPFLOAT_ROUND_STOCHASTIC_EXTEND                    (6)

/*!
 To reduce code size, not all rounding modes will be used
*/
#define POPFLOAT_ENABLE_ROUND_TO_ZERO
#define POPFLOAT_ENABLE_ROUND_TO_NEAREST_EVEN
#define POPFLOAT_ENABLE_ROUND_TO_NEAREST_AWAY
#define POPFLOAT_ENABLE_ROUND_TO_POS_INF
#define POPFLOAT_ENABLE_ROUND_TO_NEG_INF
#define POPFLOAT_ENABLE_ROUND_STOCHASTIC
#define POPFLOAT_ENABLE_ROUND_STOCHASTIC_SHORT
#undef  POPFLOAT_ENABLE_EXTENDED_STOCHASTIC_ROUND
#define POPFLOAT_ENABLE_ROUND_STOCHASTIC_HALF_MIN

...
std::uint64_t
MAKE_CYCLE_ESTIMATOR_NAME(CastGf8ToFloat)
   (const VertexIntrospector           &vertex,
    const Target                       &target){
  return 1;
}
...
std::uint64_t
MAKE_CYCLE_ESTIMATOR_NAME(CastFloatToGf8)
   (const VertexIntrospector           &vertex,
    const Target                       &target){
  return 1;
}
...
poplibs::CycleEstimatorTable makeCyclesFunctionTable() {
  poplibs::CycleEstimatorTable table = {
    ...
    CYCLE_ESTIMATOR_ENTRY(experimental::popfloat, CastToGfloat16, FLOAT, FLOAT,
                          true, RoundType::RZ),
    CYCLE_ESTIMATOR_ENTRY(experimental::popfloat, CastToGfloat16, FLOAT, FLOAT,
                          true, RoundType::RN),
    CYCLE_ESTIMATOR_ENTRY(experimental::popfloat, CastToGfloat16, FLOAT, FLOAT,
    ...
    CYCLE_ESTIMATOR_ENTRY(experimental::popfloat, CastToGfloat16InPlace, FLOAT,
                          true, RoundType::RZ),
    CYCLE_ESTIMATOR_ENTRY(experimental::popfloat, CastToGfloat16InPlace, FLOAT,
                          true, RoundType::RN),
    CYCLE_ESTIMATOR_ENTRY(experimental::popfloat, CastToGfloat16InPlace, FLOAT,
    ...
    CYCLE_ESTIMATOR_ENTRY(experimental::popfloat, CastToGfloat32, FLOAT, FLOAT,
                          true, RoundType::RZ),
    CYCLE_ESTIMATOR_ENTRY(experimental::popfloat, CastToGfloat32, FLOAT, FLOAT,
                          true, RoundType::RN),
    CYCLE_ESTIMATOR_ENTRY(experimental::popfloat, CastToGfloat32, FLOAT, FLOAT,
    ...
    CYCLE_ESTIMATOR_ENTRY(experimental::popfloat, CastToGfloat32InPlace, false,
                          RoundType::RZ),
    CYCLE_ESTIMATOR_ENTRY(experimental::popfloat, CastToGfloat32InPlace, false,
                          RoundType::RN),
    CYCLE_ESTIMATOR_ENTRY(experimental::popfloat, CastToGfloat32InPlace, false,
    ...
    CYCLE_ESTIMATOR_ENTRY(experimental::popfloat, CastToGfloat16Sr, FLOAT, HALF,
    ...
    CYCLE_ESTIMATOR_ENTRY(experimental::popfloat, CastToGfloat16Sr, HALF, HALF,
                          true, SRDensityType::UNIFORM),
    CYCLE_ESTIMATOR_ENTRY(experimental::popfloat, CastToGfloat16Sr, HALF, HALF,
                          true, SRDensityType::NORMAL),
    CYCLE_ESTIMATOR_ENTRY(experimental::popfloat, CastToGfloat16Sr, HALF, HALF,
    ...
    CYCLE_ESTIMATOR_ENTRY(experimental::popfloat, CastToGfloat16Sr, FLOAT,
                          FLOAT, false, SRDensityType::TRUNCATED_LOGIT_NORMAL),
    ...
    CYCLE_ESTIMATOR_ENTRY(experimental::popfloat, CastToGfloat16SrInPlace, HALF,
                          true, SRDensityType::UNIFORM),
    CYCLE_ESTIMATOR_ENTRY(experimental::popfloat, CastToGfloat16SrInPlace, HALF,
                          true, SRDensityType::NORMAL),
    CYCLE_ESTIMATOR_ENTRY(experimental::popfloat, CastToGfloat16SrInPlace, HALF,
    ...
    CYCLE_ESTIMATOR_ENTRY(experimental::popfloat, CastToGfloat32Sr, FLOAT, HALF,
                          true, SRDensityType::UNIFORM),
    CYCLE_ESTIMATOR_ENTRY(experimental::popfloat, CastToGfloat32Sr, FLOAT, HALF,
                          true, SRDensityType::NORMAL),
    CYCLE_ESTIMATOR_ENTRY(experimental::popfloat, CastToGfloat32Sr, FLOAT, HALF,
    ...
    CYCLE_ESTIMATOR_ENTRY(experimental::popfloat, CastToGfloat32SrInPlace, true,
                          SRDensityType::UNIFORM),
    CYCLE_ESTIMATOR_ENTRY(experimental::popfloat, CastToGfloat32SrInPlace, true,
                          SRDensityType::NORMAL),
    CYCLE_ESTIMATOR_ENTRY(experimental::popfloat, CastToGfloat32SrInPlace, true,
                          SRDensityType::TRUNCATED_NORMAL),
    CYCLE_ESTIMATOR_ENTRY(experimental::popfloat, CastToGfloat32SrInPlace, true,
                          SRDensityType::LAPLACE),
    CYCLE_ESTIMATOR_ENTRY(experimental::popfloat, CastToGfloat32SrInPlace, true,
                          SRDensityType::TRUNCATED_LAPLACE),
    CYCLE_ESTIMATOR_ENTRY(experimental::popfloat, CastToGfloat32SrInPlace, true,
                          SRDensityType::LOGISTIC),
    CYCLE_ESTIMATOR_ENTRY(experimental::popfloat, CastToGfloat32SrInPlace, true,
                          SRDensityType::TRUNCATED_LOGISTIC),
    CYCLE_ESTIMATOR_ENTRY(experimental::popfloat, CastToGfloat32SrInPlace, true,
                          SRDensityType::LOGIT_NORMAL),
    CYCLE_ESTIMATOR_ENTRY(experimental::popfloat, CastToGfloat32SrInPlace, true,

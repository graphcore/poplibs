...
void poplib_test::rnn::backward(
  ...
  for (auto i = sequenceSize; i != 0; --i) {
    ...
    if (s != sequenceSize - 1) {
      ...
      poplib_test::gemm::generalMatrixMultiply(prevGradSum, weightsFeedback,
    ...
    poplib_test::gemm::generalMatrixMultiply(gradSumThisStep, weightsInput,
...
void poplib_test::rnn::paramUpdate(
  ...
  for (auto i = sequenceSize; i != 0; --i) {
    ...
    poplib_test::gemm::generalMatrixMultiply(in1, in2, weightsInputDeltas,
                                             weightsInputDeltas,
                                             1.0, 1.0, true, false);
    ...
    poplib_test::gemm::generalMatrixMultiply(in3, in2, weightsFeedbackDeltas,

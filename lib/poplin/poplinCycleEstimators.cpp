  ...
  return {
    CYCLE_ESTIMATOR_ENTRY(poplin, TriangularInverse, FLOAT, false),
        ...
        CYCLE_ESTIMATOR_ENTRY(poplin, ConvPartialVerticalMac, HALF, FLOAT, true,
                              4),
        CYCLE_ESTIMATOR_ENTRY(poplin, ConvPartialVerticalMac, HALF, FLOAT,
                              false, 4),
        ...
        CYCLE_ESTIMATOR_ENTRY(poplin, ConvPartialnx1, HALF, HALF, false, true,
                              16),
#if __IPU_ARCH_VERSION__ >= 21
        CYCLE_ESTIMATOR_ENTRY(poplin, ConvPartialnx1, QUARTER, HALF, false,
                              false, 16),
        CYCLE_ESTIMATOR_ENTRY(poplin, ConvPartialnx1, QUARTER, HALF, false,
                              true, 16),
        CYCLE_ESTIMATOR_ENTRY(poplin, ConvPartialnx1, QUARTER, HALF, true,
                              false, 16),
        CYCLE_ESTIMATOR_ENTRY(poplin, ConvPartialnx1, QUARTER, HALF, true, true,
                              16),
#endif

        CYCLE_ESTIMATOR_ENTRY(poplin, ConvPartial1xNSLIC, HALF, FLOAT, 1, true,
                              4, 2, 4),
        CYCLE_ESTIMATOR_ENTRY(poplin, ConvPartial1xNSLIC, HALF, FLOAT, 1, false,
                              4, 2, 4),
        CYCLE_ESTIMATOR_ENTRY(poplin, ConvPartial1xNSLIC, HALF, FLOAT, 2, true,
                              4, 2, 4),
        CYCLE_ESTIMATOR_ENTRY(poplin, ConvPartial1xNSLIC, HALF, FLOAT, 2, false,
                              4, 2, 4),

        CYCLE_ESTIMATOR_ENTRY(poplin, ConvPartial1xNSLIC, HALF, HALF, 1, true,
                              4, 2, 4),
        CYCLE_ESTIMATOR_ENTRY(poplin, ConvPartial1xNSLIC, HALF, HALF, 1, false,
                              4, 2, 4),
        CYCLE_ESTIMATOR_ENTRY(poplin, ConvPartial1xNSLIC, HALF, HALF, 2, true,
                              4, 2, 4),

...
template <>
struct VertexTemplateToString<popnn::PoolingType> {
  static std::string to_string(const popnn::PoolingType &op) {
    switch(op) {
      case popnn::PoolingType::MAX: return "popnn::PoolingType::MAX";
      case popnn::PoolingType::AVG: return "popnn::PoolingType::AVG";
      case popnn::PoolingType::SUM: return "popnn::PoolingType::SUM";
    }
    POPLIB_UNREACHABLE();
  }
};

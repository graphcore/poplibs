...
public:
  ...
  IS_EXTERNAL_CODELET((ContinuousReduce<ReduceOp, PartialsType, OutType,
                                        isUpdate>::useExternal()));
...
#define DECLARE_BOOL_TYPES_REDUCTION(NAME) DECLARE_REDUCTION1(NAME, bool, bool)

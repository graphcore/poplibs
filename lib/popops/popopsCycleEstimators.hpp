...
inline const UnaryOpPerfTable unaryOpPerfInfo = {
    ...
    {{UnaryOpType::COS, HALF}, {25, false, 1}},
    ...
    {{UnaryOpType::LOGARITHM_ONE_PLUS, FLOAT}, {18, true}},
    {{UnaryOpType::LOGARITHM_ONE_PLUS, HALF}, {18, true}},
    ...
    {{UnaryOpType::SIN, HALF}, {25, false, 1}},
    ...
    {{UnaryOpType::TRUNC, FLOAT}, {3, false, 2}},
    {{UnaryOpType::TRUNC, HALF}, {11, false, 4}},
...
inline const UnaryOpPerfTable unaryOpInPlacePerfInfo = {
    ...
    {{UnaryOpType::LOGARITHM_ONE_PLUS, FLOAT}, {18, true}},
    {{UnaryOpType::LOGARITHM_ONE_PLUS, HALF}, {17, true}},
    ...
    {{UnaryOpType::TRUNC, FLOAT}, {4, false, 2}},
    {{UnaryOpType::TRUNC, HALF}, {11, false, 4}},

...
inline const UnaryOpPerfTable unaryOpPerfInfo = {
    ...
    {{UnaryOpType::ABSOLUTE, HALF}, {4, false, 4}},
    {{UnaryOpType::ABSOLUTE, INT}, {2, false}},
    {{UnaryOpType::ASIN, HALF}, {1020, false}},
    ...
    {{UnaryOpType::CEIL, HALF}, {10, false, 4}},
    {{UnaryOpType::COS, FLOAT}, {2300, false}},
    {{UnaryOpType::COS, HALF}, {3700, false}},
    {{UnaryOpType::INVERSE, HALF}, {19, false, 4}},
    {{UnaryOpType::INVERSE, FLOAT}, {8, false, 2}},
    ...
    {{UnaryOpType::EXPONENT_MINUS_ONE, HALF}, {105, false, 1}},

    // Use mul with 1.0 and use correct rounding mode
    {{UnaryOpType::FLOOR, FLOAT}, {2, true}},
    {{UnaryOpType::FLOOR, HALF}, {10, false, 4}},
    // 1 for v==v
    // 1 for v!=INFINITY
    ...
    {{UnaryOpType::ROUND, HALF}, {10, false, 4}},
    {{UnaryOpType::SIGNUM, FLOAT}, {5, true}},
    {{UnaryOpType::SIGNUM, HALF}, {5, false, 4}},
    {{UnaryOpType::SIGNUM, INT}, {5}},
    {{UnaryOpType::SIN, FLOAT}, {2300, false}},
    {{UnaryOpType::SIN, HALF}, {3700, false}},
    {{UnaryOpType::SQRT, FLOAT}, {12, false, 2}},
    {{UnaryOpType::SQRT, HALF}, {27, false, 4}},
    {{UnaryOpType::SQRT, INT}, {110, false}},
    {{UnaryOpType::SQUARE, FLOAT}, {3, false, 2}},
    {{UnaryOpType::SQUARE, HALF}, {3, false, 4}},
    {{UnaryOpType::SQUARE, INT}, {1, true}},
    {{UnaryOpType::SQUARE, UNSIGNED_INT}, {1, true}},
    {{UnaryOpType::TAN, FLOAT}, {3900, true}},
    {{UnaryOpType::TAN, HALF}, {4700, false}},

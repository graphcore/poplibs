...
inline const BinaryOpPerfTable binaryOpPerfInfo = {
    ...
    {{BinaryOpType::BITWISE_AND, SHORT}, {5, false, 2}},
    {{BinaryOpType::BITWISE_AND, UNSIGNED_SHORT}, {5, false, 2}},
    {{BinaryOpType::BITWISE_OR, INT}, {7, false, 1}},
    {{BinaryOpType::BITWISE_OR, UNSIGNED_INT}, {7, false, 1}},
    {{BinaryOpType::BITWISE_OR, SHORT}, {5, false, 2}},
    {{BinaryOpType::BITWISE_OR, UNSIGNED_SHORT}, {5, false, 2}},
...
inline const BinaryOpPerfTable broadcastOpPerfInfo = {
    ...
    {{BinaryOpType::BITWISE_AND, SHORT}, {4, false, 2}},
    {{BinaryOpType::BITWISE_AND, UNSIGNED_SHORT}, {4, false, 2}},
    {{BinaryOpType::BITWISE_OR, INT}, {6, false, 1}},
    {{BinaryOpType::BITWISE_OR, UNSIGNED_INT}, {6, false, 1}},
    {{BinaryOpType::BITWISE_OR, SHORT}, {4, false, 2}},
    {{BinaryOpType::BITWISE_OR, UNSIGNED_SHORT}, {4, false, 2}},

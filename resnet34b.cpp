...
int main(int argc, char **argv) {
  ...
  Net net(IMAGENET,
          ...
          makeLayers({
            ...
            new ConvResLayer(3, 1, 1, 64, NON_LINEARITY_RELU, 2, resMethod),
            new ConvLayer(3, 1, 1, 64, NON_LINEARITY_RELU),
            new ConvResLayer(3, 1, 1, 64, NON_LINEARITY_RELU, 2, resMethod),
            new ConvLayer(3, 1, 1, 64, NON_LINEARITY_RELU),
            new ConvResLayer(3, 1, 1, 64, NON_LINEARITY_RELU, 2, resMethod),
            ...
            new ConvResLayer(3, 1, 1, 128, NON_LINEARITY_RELU, 2, resMethod),
            ...
            new ConvResLayer(3, 1, 1, 256, NON_LINEARITY_RELU, 2, resMethod),
            ...
            new ConvResLayer(3, 1, 1, 512, NON_LINEARITY_RELU, 2, resMethod),

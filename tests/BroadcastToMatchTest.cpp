...
static void matchTest(Graph &graph, const std::vector<std::size_t> &shapeA,
  ...
  BOOST_CHECK_EQUAL_COLLECTIONS(t1shape.begin(), t1shape.end(), shapeC.begin(),
                                shapeC.end());
  BOOST_CHECK_EQUAL_COLLECTIONS(t2shape.begin(), t2shape.end(), shapeC.begin(),
                                shapeC.end());
}
...
static void matchTest(Graph &graph, const std::vector<std::size_t> &shapeA,
  ...
  auto t1shape = t1.shape();
  BOOST_CHECK_EQUAL_COLLECTIONS(t1shape.begin(), t1shape.end(), shapeB.begin(),
                                shapeB.end());
}

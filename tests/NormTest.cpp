...
static bool normTest(const DeviceType &deviceType,
  ...
  const auto fieldSize =
      std::accumulate(dims.begin() + 2, dims.end(), 1U,
  ...
  boost::multi_array<double, 3>
      hostActs(boost::extents[batchSize][numChannels][fieldSize]);
  boost::multi_array<double, 3>
      hostActsBN(boost::extents[batchSize][numChannels][fieldSize]);
  boost::multi_array<double, 3>
      hostActsBNInf(boost::extents[batchSize][numChannels][fieldSize]);
  boost::multi_array<double, 3>
  ...
  boost::multi_array<double, 3> modelActsWhitened(boost::extents[batchSize]
                                                                [numChannels]
                                                                [fieldSize]);

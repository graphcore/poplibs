...
makeParams(unsigned stride, unsigned kernelSize, unsigned paddingLower,
  unsigned paddingUpper, unsigned inputSize, bool isFractional) {
  return {"float",
...
BOOST_AUTO_TEST_CASE(inputRangeTest){
  ...
  const auto params1 = makeParams(1, 3, 0, 0, 10, false);
  ...
  // Stride = 2, no padding
  const auto params2 = makeParams(2, 3, 0, 0, 10, false);
  ...
  const auto params3 = makeParams(1, 3, 1, 0, 10, false);
  ...
  const auto params4 = makeParams(1, 3, 2, 0, 10, false);
  ...
  const auto params5 = makeParams(2, 3, 1, 0, 10, false);
  ...
  const auto params6 = makeParams(2, 3, 2, 0, 10, false);
  ...
  const auto params7 = makeParams(2, 3, 4, 0, 10, false);
  ...
  const auto params8 = makeParams(1, 3, 1, 1, 10, false);
  ...
  const auto params9 = makeParams(2, 3, 1, 2, 10, false);
  ...
  const auto params10 = makeParams(3, 3, 2, 2, 10, false);
...
getOutputDim(unsigned inDimY, unsigned inDimX,
  ...
  auto params =
      popconv::ConvParams("",
                          ...
                          stride, paddingLower, paddingUpper, isFractional);

...
// Filling the operand buffers, for boolean data. We always fill it with
...
// Filling the operand buffer for int data.
...
// Filling the operand buffer for FLOAT and HALF data (both use 'float'
// buffers on the host)
void fillBuffer(const Type &dataType, RandomEngine &rndEng,
...
void fillDataBuffer(UnaryOpType op, const Type &dataType, unsigned randomSeed,

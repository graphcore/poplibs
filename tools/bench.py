...
EXPECTED_RESULTS = {
    ...
    "bert_ffn1_128x1024x4096": Expected(cycles=121_808, total_memory=106_173_140, max_tile_mem=144_920),
    "bert_ffn1_128x768x3072": Expected(cycles=80_161, total_memory=64_505_092, max_tile_mem=138_968),
    "bert_ffn1_384x1024x4096": Expected(cycles=280_415, total_memory=193_651_504, max_tile_mem=177_016),
    "bert_ffn1_384x768x3072": Expected(cycles=177_277, total_memory=154_589_738, max_tile_mem=146_648),
    "bert_ffn1_512x1024x4096": Expected(cycles=361_290, total_memory=212_136_844, max_tile_mem=176_588),
    "bert_ffn1_512x768x3072": Expected(cycles=223_572, total_memory=152_409_848, max_tile_mem=151_832),
    "bert_ffn2_128x3072x768": Expected(cycles=84_618, total_memory=64_675_636, max_tile_mem=138_968),
    "bert_ffn2_128x4096x1024": Expected(cycles=126_523, total_memory=106_455_896, max_tile_mem=144_920),
    "bert_ffn2_384x3072x768": Expected(cycles=180_061, total_memory=154_636_218, max_tile_mem=146_648),
    "bert_ffn2_384x4096x1024": Expected(cycles=287_678, total_memory=193_822_560, max_tile_mem=175_978),
    "bert_ffn2_512x3072x768": Expected(cycles=224_186, total_memory=152_312_212, max_tile_mem=151_832),
    "bert_ffn2_512x4096x1024": Expected(cycles=369_965, total_memory=212_286_716, max_tile_mem=183_538),
    "bert_grouped_12x128x64x128": Expected(cycles=15_314, total_memory=11_044_247, max_tile_mem=132_472),
    "bert_grouped_12x384x64x384": Expected(cycles=40_951, total_memory=36_798_350, max_tile_mem=137_240),
    "bert_grouped_12x512x64x512": Expected(cycles=60_862, total_memory=56_044_578, max_tile_mem=142_040),
    "bert_grouped_16x128x64x128": Expected(cycles=17_271, total_memory=13_144_591, max_tile_mem=133_144),
    "bert_grouped_16x384x64x384": Expected(cycles=50_573, total_memory=61_394_444, max_tile_mem=139_288),
    "bert_grouped_16x512x64x512": Expected(cycles=79_933, total_memory=73_325_584, max_tile_mem=147_512),
    "bert_kqv_128x1024x3072": Expected(cycles=97_070, total_memory=82_333_700, max_tile_mem=141_464),
    "bert_kqv_128x768x2304": Expected(cycles=65_884, total_memory=51_560_578, max_tile_mem=138_904),
    "bert_kqv_384x1024x3072": Expected(cycles=218_661, total_memory=196_296_624, max_tile_mem=177_336),
    "bert_kqv_384x768x2304": Expected(cycles=144_885, total_memory=121_506_484, max_tile_mem=143_384),
    "bert_kqv_512x1024x3072": Expected(cycles=276_770, total_memory=166_908_020, max_tile_mem=157_336),
    "bert_kqv_512x768x2304": Expected(cycles=181_036, total_memory=156_575_540, max_tile_mem=147_480),
    "bert_proj_128x1024x1024": Expected(cycles=47_472, total_memory=53_564_090, max_tile_mem=135_192),
    "bert_proj_128x768x768": Expected(cycles=32_473, total_memory=32_165_035, max_tile_mem=135_192),
    "bert_proj_384x1024x1024": Expected(cycles=99_019, total_memory=77_982_626, max_tile_mem=142_040),
    "bert_proj_384x768x768": Expected(cycles=65_278, total_memory=48_666_308, max_tile_mem=137_240),
    "bert_proj_512x1024x1024": Expected(cycles=122_277, total_memory=98_555_250, max_tile_mem=142_040),
    "bert_proj_512x768x768": Expected(cycles=79_172, total_memory=61_099_880, max_tile_mem=139_288),

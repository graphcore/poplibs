...
EXPECTED_RESULTS = {
    ...
    "bert_reduce_2": Expected(cycles=5_497, total_memory=3_850_952, max_tile_mem=16_472),
    "bert_reduce_3": Expected(cycles=5_497, total_memory=3_850_952, max_tile_mem=16_472),
    "bert_reduce_4": Expected(cycles=5_552, total_memory=5_058_176, max_tile_mem=16_632),
    ...
    "resnet50_tr_bs1_bm128L0A0_reduce": Expected(cycles=3_901, total_memory=4_392_535, max_tile_mem=16_576),
    "resnet50_tr_bs1_bm128L0_reduce": Expected(cycles=4_284, total_memory=5_579_490, max_tile_mem=17_072),
    "resnet50_tr_bs1_bm64L0A0_reduce": Expected(cycles=4_088, total_memory=4_344_604, max_tile_mem=16_744),
    "resnet50_tr_bs1_cnv_reduce": Expected(cycles=4_600, total_memory=6_069_362, max_tile_mem=17_728),

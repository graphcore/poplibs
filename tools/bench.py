...
EXPECTED_RESULTS = {
    ...
    "bert_kqv_128x1024x3072": Expected(cycles=30_613, total_memory=82_334_776, max_tile_mem=141_464),
    "bert_kqv_128x768x2304": Expected(cycles=20_352, total_memory=51_561_398, max_tile_mem=138_904),
    "bert_kqv_384x1024x3072": Expected(cycles=70_586, total_memory=196_298_724, max_tile_mem=177_336),
    "bert_kqv_384x768x2304": Expected(cycles=45_655, total_memory=121_508_840, max_tile_mem=143_384),
    "bert_kqv_512x1024x3072": Expected(cycles=89_012, total_memory=166_910_120, max_tile_mem=157_336),
    "bert_kqv_512x768x2304": Expected(cycles=57_659, total_memory=156_577_128, max_tile_mem=147_480),
    "bert_proj_128x1024x1024": Expected(cycles=14_823, total_memory=53_564_090, max_tile_mem=135_192),
    "bert_proj_128x768x768": Expected(cycles=9_511, total_memory=32_165_035, max_tile_mem=135_192),
    "bert_proj_384x1024x1024": Expected(cycles=31_188, total_memory=77_982_626, max_tile_mem=142_040),
    "bert_proj_384x768x768": Expected(cycles=20_228, total_memory=48_666_308, max_tile_mem=137_240),
    "bert_proj_512x1024x1024": Expected(cycles=38_680, total_memory=98_555_250, max_tile_mem=142_040),
    "bert_proj_512x768x768": Expected(cycles=24_704, total_memory=61_099_880, max_tile_mem=139_288),
